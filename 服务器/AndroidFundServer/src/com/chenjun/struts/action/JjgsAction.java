...
import com.chenjun.struts.form.JjgsForm;
 ...
 * 
 * XDoclet definition:
 * @struts.action path="/jjgs" name="jjgsForm" input="/JjgsTestJsp.jsp" scope="request" validate="true"
 */
public class JjgsAction extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		JjgsForm jjgsForm = (JjgsForm) form;
		String dm = jjgsForm.getDm();
		
		MySQLConnection conn = new MySQLConnection();
		
		Jjgs jjgs = conn.queryJjgs(dm);
		
		Gson gson = new Gson();
		String jsonStr = gson.toJson(jjgs, jjgs.getClass());
