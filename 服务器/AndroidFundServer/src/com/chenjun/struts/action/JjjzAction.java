...
import com.chenjun.struts.form.JjjzForm;
 ...
 * 
 * XDoclet definition:
 * @struts.action path="/jjjz" name="jjjzForm" input="/form/jjjz.jsp" scope="request" validate="true"
 */
public class JjjzAction extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		JjjzForm jjjzForm = (JjjzForm) form;// TODO Auto-generated method stub
		MySQLConnection mySql = new MySQLConnection();
		
		ArrayList<Jjjz> jjjzs = null;
		
		if(jjjzForm.getLastDate() == null || jjjzForm.getLastDate().equals("")){
			jjjzs = mySql.queryJjjzsByDm(jjjzForm.getDm());
		}
		
		else{
			jjjzs = mySql.queryJjjzsByDmAndLastDay(jjjzForm.getDm(), jjjzForm.getLastDate());
		}
...
//		}
		...
		System.out.println("响应一个基金净值请求，字节数： " + resultBuffer.toByteArray().length );
		return null;
	}
}